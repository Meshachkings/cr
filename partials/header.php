...
<head>
  ...
  <title>Police Crime Record</title>
  <!-- plugins:css -->
        ...
        <ul class="nav">
          ...
          <li class="nav-item">
            <a class="nav-link" href="assign.php">
              <i class="icon-paper menu-icon"></i>
              <span class="menu-title">Manage Assigned</span>
            </a>
          </li>
          <li class="nav-item">
          ...
          <li class="nav-item">
            <a class="nav-link" href="criminals.php">
              <i class="icon-paper menu-icon"></i>
              <span class="menu-title">Manage Criminals</span>
            </a>
          </li>
          <li class="nav-item">
          ...
          <li class="nav-item">
            <a class="nav-link" href="fir.php">
              <i class="icon-paper menu-icon"></i>
              <span class="menu-title">Manage FIRs</span>
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="verification.php">
              <i class="icon-search menu-icon"></i>
              <span class="menu-title">Criminal Verification</span>
            </a>
          </li>
        </ul>
      </nav>